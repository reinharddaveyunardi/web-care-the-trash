                ...
                <div>
                    <div className="flex gap-5 flex-col relative justify-center items-center">
                        ...
                        <div className="w-[80%] text-center">
                            <small className="text-center text-xs">This image is a screenshot of the Care The Trash app. And still in development.</small>
                        </div>
                    </div>
                </div>
                <div className="h-full w-full max-w-[500px] max-h-[400px] py-[3%]">
                    <div className="flex gap-6 flex-col items-center md:items-start lg:items-start justify-start md:justify-between lg:justify-between h-full">
                        <div className="flex flex-col gap-2">
                            <h1 className="text-4xl text-center md:text-start lg:text-start font-black">Care The Trash</h1>
                            <p className="text-center md:text-start lg:text-start text-md">Manage trash easily with our modern mobile app.</p>
                        </div>
                        <div className="flex md:flex-col lg:flex-col justify-center md:justify-start lg:justify-start w-full gap-2">
                            <p>Socials: </p>
                            <a className="flex items-center gap-1" href="https://www.instagram.com/carethetrash/" target="_blank" rel="noopener noreferrer">
                                <FaInstagram />
                                @carethetrash
                            </a>
                        </div>
